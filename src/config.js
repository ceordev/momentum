...
export const config = {
  ...
  INIT_BOT_WEBHOOK: 'https://carlosolivares.app.n8n.cloud/webhook-test/start-recall-bot',
  
  // Webhook para crear tickets aprobados en Jira
  CREATE_TICKETS_WEBHOOK: 'https://carlosolivares.app.n8n.cloud/webhook-test/approved-tickets',
